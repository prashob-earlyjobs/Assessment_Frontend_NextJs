...
const ResumePage = () => {
  ...
  return (
    <>
      <Head>
        <title>EarlyJobs - AI Resume Builder Tool</title>
        <meta
          name="description"
          content="Build a professional resume easily with AI, tailored for Indian students & freshers to stand out in job applications."
        />
        <meta
          name="keywords"
          content="AI resume builder, resume tool, EarlyJobs, resume for freshers, job applications, Indian students"
        />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          property="og:title"
          content="EarlyJobs - AI Resume Builder Tool"
        />
        <meta
        ...
        <meta property="og:url" content="https://www.earlyjobs.com/resume" />

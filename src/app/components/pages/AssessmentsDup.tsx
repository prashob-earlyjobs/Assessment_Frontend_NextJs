...
export default function Assessments() {
  ...
  return (
    <div >
      {/* Hero Section */}
    <section className="h-[750px] flex items-center relative overflow-hidden bg-gradient-to-br from-orange-400 to-purple-400 py-6 px-4 sm:py-12 sm:px-6 lg:px-8 lg:py-12">
    ...
    <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-center">
      ...
      <div className="animate-fade-in text-center lg:text-left">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-6">
          ...
          <Button className="border-2 border-white text-white hover:bg-white hover:text-orange-600 font-semibold py-2.5 px-5 rounded-xl text-base transition-all duration-300 shadow-lg">
      ...
      {/* Right Image */}
      <div className="relative lg:order-last order-first flex justify-center mt-20 lg:mt-0">
              ...
              return (
                ...
                >
                  <div className="bg-white overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-[1.02] border-0 shadow-md rounded-lg group">
                    ...
                    <div className="p-5">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors">{course.title}</h3>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xl font-bold text-orange-600 group-hover:scale-110 transition-transform">{course.price}</span>
                        <Button

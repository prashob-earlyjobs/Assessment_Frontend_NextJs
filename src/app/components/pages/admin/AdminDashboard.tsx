...
const AdminDashboard: React.FC = () => {
  ...
  const franchiseActions = [
    {
      ...
      onClick: () => navigate.push('/admin/candidates'),
    },
    {
      title: 'Assessments',
      ...
      onClick: () => navigate.push('/admin/assessments'),
    },
    {
      title: 'Transactions',
      ...
      onClick: () => navigate.push('/admin/transactions'),
    },
  ];
  ...
  const adminActions = [
    ...
    },
    {
      ...
      onClick: () => navigate.push('/admin/franchises'),
    },
    {
      title: 'Transactions',
      description: 'View payment transactions',
    ...
    },
    {
      ...
      onClick: () => navigate.push('/admin/offers'),
    },
    {
      title: 'Add User',

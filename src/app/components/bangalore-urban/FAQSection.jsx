...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "What makes EarlyJobs Bangalore Urban different from other recruitment partners?",
    ...
    {
      question: "Is there any fee for students or colleges in Bangalore Urban?",
    ...
    {
      question: "How quickly can Bangalore Urban candidates get placed?",
    ...
    {
      question: "What types of roles do you help place in Bangalore Urban?",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Get answers to common questions about our Bangalore Urban services
          </p>
        </div>

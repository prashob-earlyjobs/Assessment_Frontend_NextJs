  ...
  const steps = [
    {
      ...
      step: "01",
      title: "Sign Up",
      description: "Register through our Bangalore Urban franchise portal with your details and preferences.",
      color: "blue"
    },
    {
      icon: FileText,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our streamlined process ensures quick and effective connections between talent and opportunities in Bangalore Urban.
          </p>
        </div>

...
import HeroSection from '../../components/bangalore/HeroSection'
import BenefitsSection from '../../components/bangalore/BenefitsSection';
import HowItWorksSection from '../../components/bangalore/HowItWorksSection';
import LeadCaptureForm from '../../components/bangalore/LeadCaptureForm';
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Dedicated Bangalore team with walk-in facilities</p>
              </div>
              <div className="text-center">
